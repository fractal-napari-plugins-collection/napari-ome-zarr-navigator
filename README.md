...
Using the ngio `condition tables` (TODO link), the Plate Browser allows for selecting subsets of the well list based on combinations of conditions.
...
The ROI loader supports both loading images and labels as a lazy, multi-resolution pyramid (optimized for streaming) and at fixed resolutions (optimized for interactivity e.g. for 3D images and classifier)
